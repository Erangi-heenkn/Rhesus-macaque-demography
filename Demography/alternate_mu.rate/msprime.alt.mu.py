...
N_anc = 21986
N_Ch_Current = 97534.5
N_In_Current = 5600.5
N_Ch_size = 24710
N_In_size = 45917
T_split = 80351# generations ago
Ts_Chinese = 31538
Ts_Indian = 2884
mu = 1.489e-8
recomb_rate = 5e-9
...
# add events
    ...
    demography.set_migration_rate(source="Chinese", dest="Indian", rate=1.16201e-05)
    demography.set_migration_rate(source="Indian", dest="Chinese", rate=4.09745e-05)
